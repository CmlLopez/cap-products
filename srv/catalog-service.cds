...
service CatalogService {
    ...
    entity ProjProducts as projection on logali.ProjProducts;
    entity ProjProducts2 as projection on logali.ProjProducts2;
    entity ProjProducts3 as projection on logali.ProjProducts3;
